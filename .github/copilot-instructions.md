...
The on-ramp is organized as a guide sequence plus a Mermaid-based visual
companion. Read the root [`README.md`](../README.md) and
...
- Keep `visuals/README.md` and the relevant `README.md` tables in sync
