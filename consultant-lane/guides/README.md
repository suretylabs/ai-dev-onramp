# Consultant Process-Capture Guides

These guides are the step-by-step operating layer for the Consultant
Process-Capture Lane. Use the matching page under
[`../visuals/`](../visuals/) as the mental-model companion, and the templates
under [`../templates/`](../templates/) as the durable output shape.
...
The unit of progress is a **verified process fact** (something the SME
demonstrated or stated), not a neatly filled template section.
